...
urlpatterns = [
    ...
    path('salary/<int:id>/<str:name>', views.salary, name='salary'),
    path('delete_salary/<int:sal_id>/<int:emp_id>/<str:name>', views.delete_salary, name='delete_salary'),
    path('edit_salary/<int:sal_id>/<int:emp_id>/<str:name>',views.edit_salary,name='edit_salary'),
